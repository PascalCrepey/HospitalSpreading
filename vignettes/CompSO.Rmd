...
odin_binomial100_runs <- odin_model_binomial100$run(0:(tspan_max/0.01), replicate = Nsims)
odin_binomial5_runs <- odin_model_binomial5$run(0:(tspan_max/0.2), replicate = Nsims)
