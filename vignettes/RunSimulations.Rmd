...
$$S_{i,t+1} = S_{i,t} \left( 1-\frac{\sum_{j \in n\{-i\}}\Omega_{i,j}}{N_{i,t}} \right) + \sum_{j \in n\{-i\}} \Omega_{j,i} \frac{S_{j,t}}{N_{j,t}} - \beta \frac{S_{i,t} I_{i,t}}{N_{i,t}} + \alpha I_{i,t}$$
$$I_{i,t+1} = I_{i,t} \left( 1- \frac{\sum_{j \in n\{-i\}} \Omega_{i,j}}{N_{i,t}} \right) + \sum_{j \in \{-i\}} \Omega_{j,i} \frac{I_{j,t}}{N_{j,t}} + \beta \frac{S_{i,t} I_{i,t}}{N_{i,t}}-\alpha I_{i,t}$$
...
Each subpopulation is of size **size_subpop**, The initial number of infected individuals in each subpopulation is 0 except subpopulation 1 where 3 individuals are infected.
...
We define a matrix of transfers between each subpopulation, and this is randomly chosen in this analysis.
...
```{r init_multi_models, message = F, eval=F}
Nsims = 100
...
```{r deterministic_model, echo = F, eval=F}
...
```{r plot_multi, echo = F, eval = F, fig.width = 7}
rbind(siminf_multi %>%
