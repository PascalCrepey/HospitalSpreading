...
extern SEXP odin_stoch_model_si_binom_fixing_contents(SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_create(SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_initial_conditions(SEXP, SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_metadata(SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_rhs_r(SEXP, SEXP, SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_set_initial(SEXP, SEXP, SEXP, SEXP);
extern SEXP odin_stoch_model_si_binom_fixing_set_user(SEXP, SEXP);
...
extern SEXP odin_stoch_model_sis_binom_contents(SEXP);
extern SEXP odin_stoch_model_sis_binom_create(SEXP);
extern SEXP odin_stoch_model_sis_binom_initial_conditions(SEXP, SEXP);
extern SEXP odin_stoch_model_sis_binom_metadata(SEXP);
extern SEXP odin_stoch_model_sis_binom_rhs_r(SEXP, SEXP, SEXP);
extern SEXP odin_stoch_model_sis_binom_set_initial(SEXP, SEXP, SEXP, SEXP);
